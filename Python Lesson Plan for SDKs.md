...
#### Lesson 42: Lambda expressions and `sorted()` with `key=`
...
#### Lesson 43: Classes and Instances — Reading `__init__` and `self`
...
#### Lesson 44: Methods, Attributes, and Object Chaining
...
#### Lesson 45: The `@property` decorator — why attribute access can be a method
...
#### Lesson 46: Inheritance Recognition and `isinstance()`
...
#### Lesson 47: Installing PyGithub and authenticating safely
...
#### Lesson 48: The PyGithub object model (what objects represent)
...
#### Lesson 49: Repositories I — listing and selecting repositories
...
#### Lesson 50: Repositories II — reading contents and files
...
#### Lesson 51: The `csv` module — writing structured report output
...
#### Lesson 52: Issues I — listing, filtering, and summarizing
...
#### Lesson 53: Datetime for SDK Reports
...
#### Lesson 54: Issues II — creating and updating issues safely
...
#### Lesson 55: Pull requests — reading PR metadata and review state
...
#### Lesson 56: Pagination in PyGithub — iteration behavior and performance
...
#### Lesson 57: Rate limiting — detecting, documenting, and behaving well
...
#### Lesson 58: Error behavior — mapping HTTP failures to Python exceptions
...
#### Lesson 59: Reading type hints in SDK signatures
...
#### Lesson 60: `async/await` recognition — reading modern SDK patterns
...
#### Lesson 61: Reading SDK source and docs like a writer
...
#### Lesson 62: Documenting workflows, not just methods
...
#### Lesson 63: Documentation capstone — a PyGithub feature page

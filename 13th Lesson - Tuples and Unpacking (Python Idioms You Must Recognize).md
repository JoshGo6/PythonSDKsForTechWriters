...
**Tuple unpacking** (also called "destructuring"): Tuple unpacking is the act of assigning each element of a tuple (or any sequence) to a separate variable in a single statement. For example, `name, age = ("Alice", 30)` assigns `"Alice"` to `name` and `30` to `age`. You have already been doing this without knowing it: when you write `for k, v in d.items()`, the `k, v` part is tuple unpacking — each key-value pair returned by `.items()` is a tuple, and Python unpacks it into `k` and `v` for you on every iteration.
...
$ python3 -c "t = (1, 2, 3); print(t); print(type(t))"
(1, 2, 3)
<class 'tuple'>
...
# Single-element tuple requires a trailing comma
$ python3 -c "t = ('hello',); print(t); print(type(t))"
('hello',)
<class 'tuple'>

# Without the trailing comma, it's just a string
$ python3 -c "t = ('hello'); print(t); print(type(t))"
hello
<class 'str'>

# Empty tuple
$ python3 -c "t = (); print(t); print(type(t))"
()
<class 'tuple'>

# Index into a tuple
$ python3 -c "t = ('a', 'b', 'c'); print(t[0]); print(t[-1])"
a
c

# Slice a tuple
$ python3 -c "t = (10, 20, 30, 40); print(t[1:3])"
(20, 30)

# Get the length of a tuple
$ python3 -c "t = ('x', 'y', 'z'); print(len(t))"
3

# Unpack a tuple into variables
$ python3 -c "name, age = ('Alice', 30); print(name); print(age)"
Alice
30

# Unpack in a for loop over dict .items()
$ python3 -c "d = {'a': 1, 'b': 2}; [print(k, v) for k, v in d.items()]"
a 1
b 2

# Tuples are immutable — assignment raises TypeError
$ python3 -c "t = (1, 2, 3); t[0] = 99"
